...
const BookCoverAdmin = ({className,varient="regular",bookColor="#012B48",bookImage}:BookCoverProps) => {
  return (
...
<Image src={bookImage} alt='imagecover' fill className='rounded-sm object-fill' />
        </div>
    </div>
  )
}
